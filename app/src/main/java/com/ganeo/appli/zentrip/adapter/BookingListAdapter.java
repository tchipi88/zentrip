...
import com.ganeo.appli.zentrip.adapter.viewholder.BookingViewHolder;
import com.ganeo.appli.zentrip.adapter.viewholder.DriverViewHolder;
...
public class BookingListAdapter extends BaseAdapter<Booking> {
    ...
    protected RecyclerView.ViewHolder createItemViewHolder(ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.booking_list_row, parent, false);

        final BookingViewHolder holder = new BookingViewHolder(v);
    ...
    protected void bindItemViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        final BookingViewHolder holder = (BookingViewHolder) viewHolder;

        final Booking driver = getItem(position);
        if (driver != null) {
            holder.bind(driver);
        }
    }
