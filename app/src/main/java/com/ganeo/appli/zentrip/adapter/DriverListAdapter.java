...
public class DriverListAdapter extends BaseAdapter<Driver> {
    ...
    protected RecyclerView.ViewHolder createItemViewHolder(ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.driver_list_row, parent, false);

        final DriverViewHolder holder = new DriverViewHolder(v);
